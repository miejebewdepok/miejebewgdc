  ...
  return (
    <div className="relative min-h-screen bg-[#fef2f2] dark:bg-[#090b11] text-[#450a0a] dark:text-slate-100 overflow-hidden flex items-center justify-center px-4 py-8 lg:p-12 font-sans select-none transition-colors duration-300 dark">
      ...
      <div className="w-full max-w-md relative z-10 flex flex-col gap-6 items-center">
        ...
        <Card className="w-full border border-red-100 dark:border-white/5 bg-white/70 dark:bg-slate-950/65 backdrop-blur-xl shadow-xl dark:shadow-[0_20px_50px_rgba(239,68,68,0.15)] rounded-[32px] overflow-hidden p-6 sm:p-8 transition-all duration-300">
          <div>
            ...
            {mode === "signin" ? (
              <div className="space-y-4">
                ...
                <div className="grid gap-2">
                  ...
                  <div className="relative">
                    <Lock className="absolute left-4 top-3.5 w-4 h-4 text-red-955/40 dark:text-slate-500" />
                    <Input
                      id="signin-password"
                      name="password"
                      form="signin-form"
                      ...
                      className="h-12 pl-11 pr-12 rounded-2xl bg-white dark:bg-slate-900/60 border-red-200 dark:border-white/5 text-[#450a0a] dark:text-white placeholder-red-900/30 dark:placeholder-slate-600 focus:border-red-500/50 focus:ring-red-500/20 text-sm font-semibold transition-all shadow-inner dark:shadow-none"
                    ...
                    <button
                      ...
                      className="absolute right-4 top-3.5 text-red-950/40 hover:text-red-650 dark:text-slate-500 dark:hover:text-slate-350 transition-colors cursor-pointer"
                    >
              ...
              <div className="space-y-4">
                <div className="grid gap-2">
                  ...
                  <div className="relative">
                    <User className="absolute left-4 top-3.5 w-4 h-4 text-red-955/40 dark:text-slate-500" />
                    <Input
                      id="signup-name"
                      name="name"
                      form="signup-form"
                ...
                <div className="grid gap-2">
                  ...
                  <div className="relative">
                    <Mail className="absolute left-4 top-3.5 w-4 h-4 text-red-955/40 dark:text-slate-500" />
                    <Input
                      id="signup-email"
                      name="email"
                      form="signup-form"
            ...
            {/* Footer Watermark */}
            <div className="mt-8 text-center text-[10px] text-red-950/40 dark:text-slate-500 font-medium">
